...
<div class={twMerge("flex items-center justify-between space-x-3", className)}>
  ...
  <Switch.Root
    class="peer inline-flex h-5 w-10 cursor-pointer items-center rounded-full bg-gray-600 px-0.5 transition-colors focus-visible:ring-2 focus-visible:ring-green-500
           focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-green-500 data-[state=unchecked]:bg-gray-300">
    <Switch.Thumb
      class="pointer-events-none block h-4 w-4 transform rounded-full bg-black shadow transition-transform
